...
const shippingVouchers: Voucher[] = [
  { id: 1, title: "Giảm phí ship 30k", description: "Đơn tối thiểu 60k", expired: "28.02.2025" },
  { id: 2, title: "Giảm phí ship 20k", description: "Đơn tối thiểu 50k", expired: "28.02.2025" },
  { id: 3, title: "Giảm phí ship 20k", description: "Đơn tối thiểu 50k", expired: "28.02.2025" },
  { id: 4, title: "Giảm phí ship 20k", description: "Đơn tối thiểu 50k", expired: "28.02.2025" },
  { id: 5, title: "Giảm phí ship 20k", description: "Đơn tối thiểu 50k", expired: "28.02.2025" },
  { id: 6, title: "Giảm phí ship 20k", description: "Đơn tối thiểu 50k", expired: "28.02.2025" },
  { id: 7, title: "Giảm phí ship 20k", description: "Đơn tối thiểu 50k", expired: "28.02.2025" },
];

const foodVouchers: Voucher[] = [
  { id: 1, title: "Giảm 10% món ăn", description: "Tối đa 15k", expired: "28.02.2025" },
  { id: 2, title: "Giảm 20k món ăn", description: "Đơn tối thiểu 100k", expired: "28.02.2025" },
  { id: 3, title: "Giảm 20k món ăn", description: "Đơn tối thiểu 100k", expired: "28.02.2025" },
  { id: 4, title: "Giảm 20k món ăn", description: "Đơn tối thiểu 100k", expired: "28.02.2025" },
  { id: 5, title: "Giảm 20k món ăn", description: "Đơn tối thiểu 100k", expired: "28.02.2025" },
];
    ...
    <View className="flex-1" >
      ...
      <View className="bg-white p-4 rounded-3xl shadow-md mx-5">
        <TouchableOpacity className="flex-row justify-between pb-1 border-b border-gray-200">
          <View>
            <Text className="text-gray-400 text-base font-NunitoBold">Địa chỉ của bạn</Text>
            ...
            <MaterialIcons
                ...
                name="location-pin"
              />
              <Text className="text-base my-auto font-NunitoSemiBold" style={{ maxWidth: '90%' }}>
        ...
        <TouchableOpacity className="flex-row justify-between py-1 border-b border-gray-200">
          <View>
            <Text className="text-gray-400 text-base font-NunitoBold">Phương thức thanh toán</Text>
            <View className="flex-row">
        ...
        <TouchableOpacity className="flex-row justify-between pt-1">
          <View>
            <Text className="text-gray-400 text-base font-NunitoBold">Số điện thoại</Text>
            <View className="flex-row">
            <MaterialIcons
                style={styles.icon}
                color="white"
      ...
      >
        <BottomSheetView className="p-4" style={{ height: (dimension.height * 7) / 8, overflow: "hidden" }}>
          <ScrollView contentContainerStyle={{ paddingBottom: 20 }} showsVerticalScrollIndicator={false}>
            <Text className="text-xl font-bold mb-4">Chọn mã ưu đãi</Text>
            
            <Text className="text-lg font-semibold mb-2">Ưu đãi phí vận chuyển</Text>
            <FlatList
              data={shippingVouchers}
              keyExtractor={(item) => item.id.toString()}
              scrollEnabled={false}
              renderItem={({ item }) => (
                <TouchableOpacity onPress={() => handleSelectVoucher(item)} className="flex-row items-center p-3 bg-gray-200 rounded-lg mb-2">
                  {/* <Image source={require(images.discountfood)} style={{ width: 40, height: 40, marginRight: 10 }} /> */}
                  <View>
                    <Text className="text-lg font-semibold">{item.title}</Text>
                    <Text className="text-gray-500">{item.description} - HSD {item.expired}</Text>
                  </View>
                </TouchableOpacity>
              )}
            />
            
            <Text className="text-lg font-semibold mb-2 mt-4">Ưu đãi món ăn</Text>
            <FlatList
              data={foodVouchers}
              keyExtractor={(item) => item.id.toString()}
              scrollEnabled={false}
      ...
      <TouchableOpacity className="bg-black py-4 mt-2 rounded-3xl items-center">
